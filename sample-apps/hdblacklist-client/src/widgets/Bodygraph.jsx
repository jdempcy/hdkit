...
class Bodygraph extends Component {
 ...
 drawBodygraph(match) {
  ...
  if ((match.Sun.t != pMatch.Sun.t) || 
    ...
    this.state.previousMatch = match;
    this.state.isNewChangeAppearing = true;
    let setNewChangeFalse = () => { this.state.isNewChangeAppearing = false; };
    setTimeout(setNewChangeFalse, 1500);
  }
  // console.log(match);
  // e.g. ...
  ...
  componentDidMount() {
    ...
    this.drawBodygraph(this.props.activation);
